...
def get_rate(song_liwc_dic, text_liwc , idx_dic):
...
#
# def check_function():
#     text1 = textParser.read_txt('Anywhere-But-Here.txt')
#     text2 = textParser.read_txt('Back-To-Oblivion.txt')
#     liwc_song_dic1 = textParser.activate_LIWC_algo(text1)
#     liwc_song_dic2 = textParser.activate_LIWC_algo(text2)
#     print(get_rate(liwc_song_dic1, liwc_song_dic2))

def get_most_similar_song(text_liwc_dic):
    ...
    with open(file_to_open) as f:
        for line in f:
            ...
            rate = get_rate(song_dic, text_liwc_dic, idx_dic)
            if rate > max_rate:
                max_rate = rate
                max_song = json_obj['name']
                max_artist = json_obj['artist']
